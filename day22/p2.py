# im really not good at the cube walking math...
# and just tested 2019-nCOV positive with high fever...
# give up part2 of day22
# the following code is from https://github.com/blu3r4y/AdventOfCode2022/blob/main/src/day22.py
...
if __name__ == "__main__":
    ...
    #     ans1 = part1(load(f.read()))
    #     print(ans1)
    with open('input.txt') as f:
        ans2 = part2(load(f.read()))
        print(ans2)